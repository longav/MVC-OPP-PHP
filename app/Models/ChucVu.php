...
class ChucVu extends Model implements base
{
   ...
   private $tableName;
    ...
    public function add($data)
    {
       ...
       $sql = "INSERT INTO `chuc_vus`($columns) VALUES ($placeholders)";
    ...
    public function update($arr, $id)
{
    ...
    try {
        ...
        // Tạo câu truy vấn SQL với các placeholder
        $sql = "UPDATE `chuc_vus` SET $setString WHERE `id` = :id";
...
public function Search($data){
    ...
    $sql = "SELECT * FROM `chuc_vus` WHERE `ten_chuc_vu` LIKE :search_term";
    $stmt = $this -> conn->prepare($sql);
